...
namespace ShimmerAPI
{
    ...
    {
        public static bool tempvalue=false;
        // global variable for shimmer state
        ...
        public void ControlForm_Load(object sender, EventArgs e)
        {
            ...
            tsStatusLabel.Text = "";
           // comboBoxComPorts.SelectedText = "COM3";
            ComPort = comboBoxComPorts.SelectedText;
            // btsd changes1
        ...
        public void Connect()
        {
            ...
            //MessageBox.Show("Inside Connect");
        ...
        public void buttonStream_Click(object sender, EventArgs e)
        {
            //int[] a = new int [1];
            //a[2] = 3;
           // MessageBox.Show("in stream ");
            FirstTime = true;
            //labelPRR.Visible = true;
        ...
        public void buttonReload_Click(object sender, EventArgs e)
        {
            ...
            //    comboBoxComPorts.Items.Add(s);
            //}
            comboBoxComPorts.SelectedValue = "COM3";
        ...
        private void textBoxShimmerState_TextChanged(object sender, EventArgs e)
        {
